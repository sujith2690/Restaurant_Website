    ...
    return (
        <div className='max-w-[1640px] m-auto px-4 py-12 '>
            ...
            <div className='flex flex-col lg:flex-row justify-between'>
                {/* Filter Type */}
                <div>
                    <p className='font-bold text-gray-400'>Filter Type</p>
                    <div className='flex justify-between flex-wrap'>
                        ...
                        <button onClick={()=>filterType('burger')} className='mr-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>Burgers</button>
                ...
                {/* Filter Price */}
                <div>
                    <p className='font-bold text-gray-400'>Filter Price</p>
            ...
            <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4'>
                { foods.map((item,i)=>(
                    <div key={i} className='border-none bg-slate-800 shadow-2xl rounded-lg hover:scale-105 duration-300' >
